...
音韻地位3 = QE.音韻地位.from描述('幫三凡入')
assert 音韻地位1 == 音韻地位3
assert len({音韻地位1, 音韻地位3}) == 1

# 測試欣韻和眞韻的容錯
assert QE.音韻地位.from描述('影開三A眞平').描述 == '影開三A真平'
assert QE.音韻地位.from描述('溪開三欣上').描述 == '溪開三殷上'
